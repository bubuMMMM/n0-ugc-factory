...
(function () {
  ...
  const uploads = [
    {id:'kebab-collection-08',src:'/media/kebab/collection-f13b42e6.mp4',embeddedText:true,hook:''},
    {id:'kebab-collection-09',src:'/media/kebab/collection-5d27d39c.mp4',embeddedText:true,hook:''},
    {id:'kebab-collection-10',src:'/media/kebab/collection-a3e99d9c.mp4',embeddedText:true,hook:''},
